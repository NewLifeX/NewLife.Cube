...
layui.define('jquery', function(exports) {
    ...
    Element.prototype.tab = function(options) {
        ...
        dom.on('click', options.headerElem, function(e) {
            ...
            call.tabClickCube.call(this, e, index, null, options);
        });
    };
    ...
    , call = {
        ...
        //Tab删除（魔方）
        ,
        tabDeleteCube: function(e, othis) {
            var li = othis || $(this).parent(),
                index = li.index(),
                parents = li.parents('.cube-tab').eq(0),
                item = parents.children('.cube-tab-content').children('.layui-tab-item'),
                filter = parents.attr('lay-filter');

            if (li.hasClass(THIS)) {
                if (li.next()[0]) {
                    call.tabClickCube.call(li.next()[0], null, index + 1);
                } else if (li.prev()[0]) {
                    call.tabClickCube.call(li.prev()[0], null, index - 1);
                }
            }
            ...
            layui.event.call(this, MOD_NAME, 'tabDeleteCube(' + filter + ')', {
                elem: parents,
                index: index
            });
        }
        ...
        tabAutoCube: function() {
            ...
            $('.cube-tab').each(function() {
                var othis = $(this),
                    title = othis.children('.cube-tab-title'),
        ...
        //隐藏更多tab(魔方)
        ,
        hideTabMoreCube: function(e) {
            var tsbTitle = $('.cube-tab-title');
