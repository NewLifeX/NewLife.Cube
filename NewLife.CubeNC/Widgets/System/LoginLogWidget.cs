...
[Widget("LoginLog", "登录与在线", Icon = "fa-users", Cols = 6, Sort = 40, Category = "系统", AdminOnly = true)]
public class LoginLogWidget : IWidget
{
    ...
    public Object GetData()
    {
        ...
        var logins = XLog.FindAll(XLog._.Action.Contains("登录") & XLog._.CreateTime >= start, "CreateTime desc", null, 0, 10);
        var loginCount = XLog.FindCount(XLog._.Action.Contains("登录") & XLog._.CreateTime >= start);
