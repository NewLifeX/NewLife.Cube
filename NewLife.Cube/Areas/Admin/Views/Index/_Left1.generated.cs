...
namespace ASP
{
    ...
    String[] icons = new String[] { "fa-tachometer", "fa-desktop", "fa-list", "fa-pencil-square-o", "fa-list-alt", "fa-calendar", "fa-picture-o", "fa-tag", "fa-file-o",
...
WriteAttribute("src", Tuple.Create(" src=\"", 1243), Tuple.Create("\"", 1265)
, Tuple.Create(Tuple.Create("", 1249), Tuple.Create<System.Object, System.Int32>(Href("~/image/logo.png")
, 1249), false)
);
...
WriteAttribute("src", Tuple.Create(" src=\"", 2149), Tuple.Create("\"", 2171)
, Tuple.Create(Tuple.Create("", 2155), Tuple.Create<System.Object, System.Int32>(Href("~/image/logo.png")
, 2155), false)
);
...
WriteAttribute("class", Tuple.Create(" class=\"", 2537), Tuple.Create("\"", 2562)
, Tuple.Create(Tuple.Create("", 2545), Tuple.Create("fa", 2545), true)
            
            #line 58 "..\..\Areas\Admin\Views\Index\_Left.cshtml"
, Tuple.Create(Tuple.Create(" ", 2547), Tuple.Create<System.Object, System.Int32>(icons[_idx++]
