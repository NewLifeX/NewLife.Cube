...
/// <summary>页面 AI 数据上下文提供者。非实体页面控制器实现本接口后，AI 的 get_page_context 工具优先调用其服务端实现</summary>
/// <remarks>
/// 任意页面控制器（继承 <see cref="Common.AiPageControllerBase"/> 或自行提供 AiChat 端点）实现本接口，
/// 即可为 AI 助手提供当前页面的结构化数据上下文（图表数据、报表聚合、配置摘要等 DOM 无法体现的内容）。
