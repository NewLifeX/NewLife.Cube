...
public partial class MailConfig : Entity<MailConfig>
{
    #region 对象操作
    ...
    // Select Count(Id) as Id,Category From MailConfig Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
    //static readonly FieldCache<MailConfig> _CategoryCache = new(nameof(Category))
    //{
