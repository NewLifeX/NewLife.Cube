        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case "PrimaryKey": return _PrimaryKey;
                    ...
                    case "CellText": return _CellText;
                    case "CellTitle": return _CellTitle;
                    case "CellUrl": return _CellUrl;
                    case "HeaderText": return _HeaderText;
                    case "HeaderTitle": return _HeaderTitle;
                    case "HeaderUrl": return _HeaderUrl;
                    case "DataAction": return _DataAction;
                    case "DataSource": return _DataSource;
