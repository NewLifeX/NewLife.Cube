...
namespace NewLife.Cube.Entity
{
    ...
    public partial class ModelColumn : Entity<ModelColumn>
    {
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            // 检查唯一索引
            // CheckExist(isNew, nameof(TableId), nameof(Name));
        }
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化ModelColumn[模型列]数据……");
        ...
        //    entity.ShowInList = true;
        //    entity.ShowInForm = true;
        //    entity.ShowInSearch = true;
        //    entity.Sort = 0;
        //    entity.Width = "abc";
        //    entity.CellText = "abc";
        //    entity.CellTitle = "abc";
        //    entity.CellUrl = "abc";
        //    entity.HeaderText = "abc";
        //    entity.HeaderTitle = "abc";
        //    entity.HeaderUrl = "abc";
        //    entity.DataAction = "abc";
        //    entity.DataSource = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化ModelColumn[模型列]数据！");
        //}
        ...
        // Select Count(Id) as Id,Category From ModelColumn Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By Id Desc limit 20
        //static readonly FieldCache<ModelColumn> _CategoryCache = new FieldCache<ModelColumn>(nameof(Category))
        //{
